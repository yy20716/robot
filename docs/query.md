...
This produces <a href="/examples/query/cell_part.csv" target="_blank">`cell_part.csv`</a>.
...
This produces <a href="/examples/query/part_of.ttl" target="_blank">`part_of.ttl`</a>.

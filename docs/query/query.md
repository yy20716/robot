...
queries against an ontology. The <a href="/verify/verify">verify</a> command is similar, but is used to test that an ontology conforms to the specified rules.
...
This produces <a href="/query/cell_part.csv" target="_blank">`cell_part.csv`</a>.
...
This produces <a href="/query/part_of.ttl" target="_blank">`part_of.ttl`</a>.
